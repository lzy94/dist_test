...
import DetailModal from './ArchiveModal';

const authority = ['/lawment/dynamic/penalty'];
...
class TableList extends PureComponent {
        ...
        <Fragment>
          ...
          {checkAuth(authority[0]) ? (
            <Fragment>
              ...
              <Tooltip placement="left" title="签批">
                <Button
  ...
  //         </>
  //       )}
  //       {!!reviewerConfirm && !principalConfirm && (
  //         <>
  //           <Divider type="vertical" />
  ...
  showDetailModal = ({ id, previewCode, reviewerConfirm, principalConfirm }) => {
    this.setState({
      detailID: id,
      previewCode,
      RPType: {
  ...
  render() {
    ...
    const { modalVisible, detailID, previewCode, RPType } = this.state;
