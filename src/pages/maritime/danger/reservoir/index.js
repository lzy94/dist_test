...
@connect(({ MaritimeReservoir, loading }) => ({
  MaritimeReservoir,
  loading: loading.models.MaritimeReservoir,
}))
@Form.create()
    ...
    return (
      <Form onSubmit={this.handleSearch} layout="inline">
        <Row gutter={16}>
          <Col md={6} sm={24}>
            <FormItem>
              {getFieldDecorator('principal')(<Input addonBefore="负责人" placeholder="请输入" />)}
            </FormItem>
          </Col>
          <Col md={6} sm={24}>
            <FormItem>
              {getFieldDecorator('phone')(<Input addonBefore="电话" placeholder="请输入" />)}
            </FormItem>
          </Col>
          <Col md={6} sm={24}>
