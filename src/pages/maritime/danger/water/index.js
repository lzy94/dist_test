...
@connect(({ MaritimeDangerWater, loading }) => ({
  MaritimeDangerWater,
  loading: loading.models.MaritimeDangerWater,
}))
@Form.create()
class TableList extends PureComponent {
  ...
  getList = params => {
    ...
    dispatch({
      type: 'MaritimeDangerWater/fetch',
      payload: params,
    });
  };

  showDetailModal = detail => {
    this.setState({ detail }, () => this, this.handleModalVisible(true));
  };
  ...
  delUtil = (ids, callback) => {
    const { dispatch } = this.props;
    dispatch({
      type: 'MaritimeDangerWater/remove',
      payload: { ids },
      callback: () => {
