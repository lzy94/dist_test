...
class TableList extends PureComponent {
  ...
  handleSearch = e => {
    ...
    form.validateFields((err, fieldsValue) => {
      if (err) return;
      const values = {
        companyName: fieldsValue.name,
        areaCity: fieldsValue.area,
        contractSegment: fieldsValue.project,
      };
    ...
    return (
      <Form onSubmit={this.handleSearch} layout="inline">
        <Row gutter={16}>
          <Col md={5} sm={24}>
            <FormItem>
              {getFieldDecorator('name')(<Input addonBefore="企业名称名称" placeholder="请输入" />)}
            </FormItem>
          </Col>
          <Col md={5} sm={24}>
            <FormItem>
              {getFieldDecorator('area')(<Input addonBefore="区域" placeholder="请输入" />)}
            </FormItem>
          </Col>
          <Col md={5} sm={24}>
            <FormItem>
              {getFieldDecorator('project')(
                <Input addonBefore="项目及合同段" placeholder="请输入" />,
              )}
            </FormItem>
          </Col>
          <Col md={4} sm={24}>
