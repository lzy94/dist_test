...
class TableList extends PureComponent {
  ...
  delUtil = ids => {
    ...
    dispatch({
      type: 'BuildProgressControl/remove',
      payload: { ids },
      callback: () => {
  ...
  getList = parmas => {
    const { dispatch } = this.props;
    dispatch({
      type: 'BuildProgressControl/fetch',
      payload: parmas,
    });
  };
  ...
  showDetailModal = detailID => {
    const { dispatch } = this.props;
    dispatch({
      type: 'BuildProgressControl/detail',
      payload: detailID,
      callback: detail => {
        this.setState(
          {
  ...
  handleSearch = e => {
    ...
    form.validateFields((err, fieldsValue) => {
      ...
      const values = {
        ...
        projectCategory: fieldsValue.cate,
      };
