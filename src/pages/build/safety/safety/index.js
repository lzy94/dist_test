  ...
  handleSearch = e => {
    ...
    form.validateFields((err, fieldsValue) => {
      ...
      const values = {
        ...
        inspectors: fieldsValue.jcry,
        underUnit: fieldsValue.sjdw,
      };
    ...
    return (
      <Form onSubmit={this.handleSearch} layout="inline">
        <Row gutter={16}>
          ...
          <Col md={5} sm={24}>
            <FormItem>
              {getFieldDecorator('jcry')(<Input addonBefore="检查人员" placeholder="请输入" />)}
            </FormItem>
          </Col>
          <Col md={5} sm={24}>
            <FormItem>
              {getFieldDecorator('sjdw')(<Input addonBefore="受检单位" placeholder="请输入" />)}
            </FormItem>
          </Col>
          <Col md={4} sm={24}>
